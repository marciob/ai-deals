...
export const STATUS_CSS_CLASSES: Record<TaskStatus, string> = {
  DRAFT: "bg-surface-highlight text-status-draft",
  POSTED: "bg-status-posted/10 text-status-posted",
  MATCHED: "bg-status-matched/10 text-status-matched",
  ESCROWED: "bg-status-escrowed/10 text-status-escrowed",
  ACCEPTED: "bg-status-accepted/10 text-status-accepted",
  IN_PROGRESS: "bg-status-in-progress/10 text-status-in-progress",
  PROOF_SUBMITTED: "bg-status-proof-submitted/10 text-status-proof-submitted",
  VERIFIED: "bg-status-verified/10 text-status-verified",
  PAID: "bg-status-paid/10 text-status-paid",
  CLOSED: "bg-surface-highlight text-status-closed",
  TIMED_OUT: "bg-status-timed-out/10 text-status-timed-out",
  REFUNDED: "bg-status-refunded/10 text-status-refunded",
  PROOF_REJECTED: "bg-status-proof-rejected/10 text-status-proof-rejected",
};
